...
export class Board {
    ...
    setupInitialBoard() {
        ...
        this.squares[1] = new Piece('knight', 'black', PIECE_VALUES.knight, PIECE_SYMBOLS.knight.black);
        this.squares[2] = new Piece('bishop', 'black', PIECE_VALUES.bishop, PIECE_SYMBOLS.bishop.black);
        this.squares[3] = new Piece('queen', 'black', PIECE_VALUES.queen, PIECE_SYMBOLS.queen.black);
        this.squares[4] = new Piece('king', 'black', PIECE_VALUES.king, PIECE_SYMBOLS.king.black);
        this.squares[5] = new Piece('bishop', 'black', PIECE_VALUES.bishop, PIECE_SYMBOLS.bishop.black);
        this.squares[6] = new Piece('knight', 'black', PIECE_VALUES.knight, PIECE_SYMBOLS.knight.black);
        ...
        this.squares[57] = new Piece('knight', 'white', PIECE_VALUES.knight, PIECE_SYMBOLS.knight.white);
        this.squares[58] = new Piece('bishop', 'white', PIECE_VALUES.bishop, PIECE_SYMBOLS.bishop.white);
        this.squares[59] = new Piece('queen', 'white', PIECE_VALUES.queen, PIECE_SYMBOLS.queen.white);
        this.squares[60] = new Piece('king', 'white', PIECE_VALUES.king, PIECE_SYMBOLS.king.white);
        this.squares[61] = new Piece('bishop', 'white', PIECE_VALUES.bishop, PIECE_SYMBOLS.bishop.white);
        this.squares[62] = new Piece('knight', 'white', PIECE_VALUES.knight, PIECE_SYMBOLS.knight.white);
