    ...
    generatePawnMoves(piece, position) {
        ...
        if (this.isValidSquare(oneSquareForward) && !this.board.squares[oneSquareForward]) {
            ...
            if (currentRank === startingRank) {
                ...
                if (this.isValidSquare(twoSquaresForward) && !this.board.squares[twoSquaresForward]) {
                    moves.push({
                        from: position,
        ...
        for (const offset of captureOffsets) {
            ...
            if (this.isValidSquare(captureSquare) && this.isValidPawnCapture(position, captureSquare)) {
